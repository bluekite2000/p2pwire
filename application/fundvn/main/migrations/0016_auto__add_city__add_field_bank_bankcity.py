...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bank.bankcity'
        db.add_column('main_bank', 'bankcity', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.City']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bank.bankcity'
        db.delete_column('main_bank', 'bankcity_id')
