...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecipientBankAccount.createdby'
        db.add_column('main_recipientbankaccount', 'createdby', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator_of_recipient_account', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RecipientBankAccount.createdby'
        db.delete_column('main_recipientbankaccount', 'createdby_id')
