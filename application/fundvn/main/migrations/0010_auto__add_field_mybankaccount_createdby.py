...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBankAccount.createdby'
        db.add_column('main_mybankaccount', 'createdby', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator_of_sender_account', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBankAccount.createdby'
        db.delete_column('main_mybankaccount', 'createdby_id')
