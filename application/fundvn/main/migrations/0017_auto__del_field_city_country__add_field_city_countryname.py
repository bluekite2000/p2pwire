...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_city', 'country_id')

        # Adding field 'City.countryname'
        db.add_column('main_city', 'countryname', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['main.Country']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'City.country'
        raise RuntimeError("Cannot reverse this migration. 'City.country' and its values cannot be restored.")

        # Deleting field 'City.countryname'
        db.delete_column('main_city', 'countryname_id')
