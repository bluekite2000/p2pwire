...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_transaction', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['main.BankAccount']))

        # Changing field 'Transaction.receiver'
        db.alter_column('main_transaction', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['main.BankAccount']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Transaction.sender'
        db.alter_column('main_transaction', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['auth.User']))

        # Changing field 'Transaction.receiver'
        db.alter_column('main_transaction', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['auth.User']))
