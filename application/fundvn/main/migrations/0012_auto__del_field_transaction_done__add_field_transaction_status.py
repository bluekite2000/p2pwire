...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.done'
        db.delete_column('main_transaction', 'done')

        # Adding field 'Transaction.status'
        db.add_column('main_transaction', 'status', self.gf('django.db.models.fields.CharField')(default='Pending', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Transaction.done'
        db.add_column('main_transaction', 'done', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Transaction.status'
        db.delete_column('main_transaction', 'status')
    ...
    models = {
        ...
        'main.transaction': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Pending'", 'max_length': '1'})
        }
    }
