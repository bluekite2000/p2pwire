...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.createdby'
        db.add_column('main_transaction', 'createdby', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.createdby'
        db.delete_column('main_transaction', 'createdby_id')
