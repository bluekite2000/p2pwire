...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecipientBankAccount.email'
        db.alter_column('main_recipientbankaccount', 'email', self.gf('django.db.models.fields.EmailField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'RecipientBankAccount.email'
        db.alter_column('main_recipientbankaccount', 'email', self.gf('django.db.models.fields.CharField')(max_length=20))
